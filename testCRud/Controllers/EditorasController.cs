...
namespace testCrud.Controllers
{
    public class EditorasController : Controller
    {
        ...
        public EditorasController(testCrudContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CPNJ,Nome,Endereco")] Editora editora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CPNJ,Nome,Endereco")] Editora editora)
        {
            if (id != editora.Id)
            {
                return NotFound();
